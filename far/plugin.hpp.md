...
### Key Classes
- **`FAR_INPUT_RECORD`**: Implements far input record functionality
...
### Summary
The `plugin.hpp` file is essential for plugin system and extension management. It defines 125 class(es) and implements 9 function(s) that support Far Manager file manager operations.
...
### Podsumowanie
Plik `plugin.hpp` jest niezbędny dla systemu wtyczek i zarządzania rozszerzeniami. Definiuje 125 klas(y) i implementuje 9 funkcji wspierających operacje menedżera plików Far Manager.
