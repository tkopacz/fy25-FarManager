...
- `OnlyAltShiftPressed()`: Event handler invoked when lyAltShiftPressed occurs
- `OnlyCtrlShiftPressed()`: Event handler invoked when lyCtrlShiftPressed occurs
### Summary
...
- `OnlyAltShiftPressed()`: Procedura obsługi zdarzeń wywoływana gdy lyAltShiftPressed występuje
- `OnlyCtrlShiftPressed()`: Procedura obsługi zdarzeń wywoływana gdy lyCtrlShiftPressed występuje
### Podsumowanie
